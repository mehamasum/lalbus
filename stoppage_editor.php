...
<head>
    ...
    <title>Add New Stoppage | Lalbus</title>
...
<div class="content">
    ...
    <form class="login-form" action="#" method="POST">
        ...
        <div class="alert alert-success" id="success-alert" style="display: none;">
            ...
            Your suggestion for new bus stoppage has been accepted.
        </div>
        ...
        <div class="form-actions">
            <button type="button"  id="submit_btn" onclick="validateScheduleEdit()" class="btn red btn-block" data-loading-text="Updating..">Submit</button>
        </div>
    </form>
