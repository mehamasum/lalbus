...
function findMyBus(busId, name) {
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if(this.responseText.indexOf("EMPTY")!=-1) {
                ...
                div.append('<button onclick="login()" class="btn btn-primary">Login to report new location</button>');
            }
            else {
                ...
                div.html('<div>'+
                    ...
                    '<button onclick="login()" class="btn btn-primary">Login to report new location</button>'+
    ...
    xhttp.open("POST", "backend/find_my_bus_guest.php", true);
